...
function rectArea (sideA, sideB) { return sideA * sideB }
...
const dimensions = [[4,6],[13,3],[4,8]];
const [room1,room2,room3] = dimensions.map( dimension => rectArea(dimension[0],dimension[1]))
