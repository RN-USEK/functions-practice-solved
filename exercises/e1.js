...
function logMyMessage(message){console.log(message)}
...
function logMessageWithMyName(name){console.log(`My name is ${name}!`)}
...
function logMyInfo(name, age){console.log(`My name is ${name}. I am ${age} years old!`)}
